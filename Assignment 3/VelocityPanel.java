...
public class VelocityPanel extends JPanel implements Runnable, PropertyChangeListener {
        ...
        // constantly update the map's selected plane with a new velocity.
        public void run() {
                while (true) {
                        if (velocity.hasUpdate()) {
                                updateVelocity();
                        }
